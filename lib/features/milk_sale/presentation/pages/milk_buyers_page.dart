...
class MilkBuyersPage extends GetView<MilkBuyersController> with CommonMixin {
  MilkBuyersPage({super.key});

  final MilkBuyersController _milkBuyersController =
      Get.find<MilkBuyersController>();
            ...
            () => Visibility(
              ...
              child: Visibility(
                ...
                replacement: RetryWidget(
                  onRetry: () => _milkBuyersController.getAllMilkBuyers(),
                ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Obx(
                      () => Row(
                        children: List.generate(
                          _milkBuyersController.statusFilters.length,
                          (index) => _buildSuppliersStatusFilter(
                            _milkBuyersController.statusFilters[index]['title'],
                            index,
                          ),
                        ),
                      ),
                    ...
                    _buildTitleHeader(),
                    Expanded(
                      child: GetBuilder<MilkBuyersController>(
                        builder: (controller) {
                          return Visibility(
                            visible: _milkBuyersController
                                .filteredBuyersList
                                .isNotEmpty,
                            ...
                            child: ListView.builder(
                              ...
                              itemCount: _milkBuyersController
                                  .filteredBuyersList
                                  .length,
                              itemBuilder: (context, index) {
                                return _buildMilkBuyerWidget(
                                  index,
                                  _milkBuyersController
                                      .filteredBuyersList[index],
                                  context,
                                );
                              },
                            ),
    ...
    return Center(
      child: Column(
        children: [
          ...
          Gap.verticalGap(10),
          InkWell(
            onTap: () => AppNavigation.goToAddMilkBuyerPage(),
            child: AppButton(
              buttonWidth: 100.w,
              buttonHeight: 30.h,
              shadowOpacity: 0.6,
      ...
      children: [
        Container(
          ...
          child: TextFormField(
            ...
            controller: _milkBuyersController.searchController,
            cursorColor: AppColors.grey500,
            cursorHeight: 20,
            onChanged: (value) => _milkBuyersController.searchBuyers(value),
        ...
        children: [
          Row(
            children: [
              ...
              TextWidget(
                text:
                    '${_milkBuyersController.milkBuyersResponseModel.activeCount}/200',
                fontSize: 11.5.sp,
                fontWeight: FontWeight.w600,
          ...
          Row(
            children: [
              ...
              Gap.horizentalGap(5),
              TextWidget(
                text: _milkBuyersController
                    .milkBuyersResponseModel
                    .inactiveCount
                    .toString(),
                fontSize: 11.5.sp,
                fontWeight: FontWeight.w600,
          ...
          Row(
            children: [
              ...
              Gap.horizentalGap(5),
              TextWidget(
                text: _milkBuyersController.milkBuyersResponseModel.totalCount
                    .toString(),
                fontSize: 11.5.sp,
                fontWeight: FontWeight.w600,
                textColor: AppColors.grey800,
  ...
  _buildMilkBuyerWidget(
    int index,
    MilkBuyerModel milkBuyer,
    BuildContext context,
  ) {
    bool isActive = milkBuyer.status;
    return InkWell(
      onTap: () {
        if (!milkBuyer.status) return;

        AppState.currentBuyerForUpdate = milkBuyer;
        AppState.isMilkBuyerEdit = true;
        AppNavigation.goToAddMilkBuyerPage();
      },
      child: Container(
        width: 1.sw,
        ...
        child: Column(
          ...
          children: [
                ...
                children: [
                      ...
                      Column(
                        ...
                        children: [
                          SizedBox(
                            width: 180.w,
                            child: TextWidget(
                              text: milkBuyer.buyerName.capitalize!,
                              textColor: isActive
                                  ? AppColors.grey800
                                  : AppColors.grey300,
                              fontSize: 13.sp,
                  ...
                  Row(
                    ...
                    children: [
                        ...
                        onTap: () => showMyBottomSheet(
                          ...
                          SelectBoolOptionWidget(
                            ...
                            callback: () async {
                              ...
                              await _milkBuyersController.changeBuyerStatus(
                                milkBuyer,
                              );
                            },
                          ),
                      ...
                      InkWell(
                        onTap: () => isActive
                            ? makePhoneCall(milkBuyer.buyerMobile)
                            : null,
                        child: AppIcons.call(
                          size: 13,
                          color: isActive
            ...
            // Divider(thickness: 0.3, color: AppColors.grey200, height: 5.h),

            // Row(
            //   mainAxisAlignment: MainAxisAlignment.spaceBetween,
            //   children: [
            //     TextWidget(
            //       text: 'Added on: ${formatDate(milkBuyer.createdAt)}',
            //       textColor: AppColors.grey300,
  ...
  _buildSuppliersStatusFilter(String title, int index) {
    return Obx(() {
      RxBool isSelected =
          (_milkBuyersController.currentStatusFilterIndex.value == index).obs;
      return InkWell(
        splashColor: AppColors.transparentColor,
        onTap: () {
          _milkBuyersController.selectStatus(index);
        },
        child: Container(
          height: 25.h,
