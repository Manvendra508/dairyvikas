// lib/injection.dart
import 'package:DairyVikas/common/common_controller.dart';
import 'package:DairyVikas/core/local_datasources/secured_storage_service.dart';
import 'package:DairyVikas/features/auth/login/data/datasources/login_vendor_ds.dart';
import 'package:DairyVikas/features/auth/login/data/repos_impl/login_vendor_repo_impl.dart';
...
import 'package:DairyVikas/features/auth/login/domain/usecases/reset_password_usecase.dart';
import 'package:DairyVikas/features/auth/login/domain/usecases/send_otp_to_registred_number_usecase.dart';
import 'package:DairyVikas/features/auth/login/domain/usecases/verify_forgot_password_otp_usecase.dart';
import 'package:DairyVikas/features/auth/login/presentation/controllers/forgot_password_controller.dart';
import 'package:DairyVikas/features/auth/login/presentation/controllers/login_controller.dart';
import 'package:DairyVikas/features/auth/registration_flow/data/datasources/register_vendor_ds.dart';
import 'package:DairyVikas/features/auth/registration_flow/data/repos_impl/register_vendor_impl.dart';
...
import 'package:DairyVikas/features/auth/registration_flow/presentation/controllers/dairy_center_settings_controller.dart';
import 'package:DairyVikas/features/auth/registration_flow/presentation/controllers/otp_verify_controller.dart';
import 'package:DairyVikas/features/auth/registration_flow/presentation/controllers/register_vendor_controller.dart';
import 'package:DairyVikas/features/collection/data/datasources/collection_ds.dart';
import 'package:DairyVikas/features/collection/data/repos_impl/collection_repo_impl.dart';
...
import 'package:DairyVikas/features/collection/domain/usecases/get_all_collection_usecase.dart';
import 'package:DairyVikas/features/collection/domain/usecases/get_assigned_charts_usecase.dart';
import 'package:DairyVikas/features/collection/domain/usecases/get_collection_adjusments_usecase.dart';
import 'package:DairyVikas/features/collection/domain/usecases/get_date_range_usecase.dart';
...
import 'package:DairyVikas/features/collection/presentation/controllers/customer_pdf_sheet_controller.dart';
import 'package:DairyVikas/features/dashboard/data/datasources/dashboard_data_ds.dart';
import 'package:DairyVikas/features/dashboard/data/repos_impl/dashboard_data_repo_impl.dart';
...
import 'package:DairyVikas/features/food/data/repo_impls/food_repo_impls.dart';
import 'package:DairyVikas/features/food/domain/repository/food_repo.dart';
import 'package:DairyVikas/features/food/domain/usecases/add_food_dealer_usecase.dart';
import 'package:DairyVikas/features/food/domain/usecases/add_food_sale_usecase.dart';
import 'package:DairyVikas/features/food/domain/usecases/add_food_stock_usecase.dart';
import 'package:DairyVikas/features/food/domain/usecases/get_food_dealers_usecase.dart';
import 'package:DairyVikas/features/food/domain/usecases/get_food_sales_usecase.dart'
    show GetFoodSalesUsecase;
import 'package:DairyVikas/features/food/domain/usecases/get_units_usecase.dart';
import 'package:DairyVikas/features/food/domain/usecases/update_food_dealer_usecase.dart';
import 'package:DairyVikas/features/food/domain/usecases/update_food_stock_usecase.dart';
import 'package:DairyVikas/features/food/domain/usecases/update_sale_usecase.dart';
...
import 'package:DairyVikas/features/food/presentation/controllers/food_dealers_controller.dart';
...
import 'package:DairyVikas/features/invoices/data/repos_impl/invoice_repo_impl.dart';
...
import 'package:DairyVikas/features/khata/presentation/controllers/khata_entries_controller.dart';
import 'package:DairyVikas/features/milk_sale/data/datasources/milk_sale_ds.dart';
import 'package:DairyVikas/features/milk_sale/data/repo_impls/milk_sale_repo_impl.dart';
...
import 'package:DairyVikas/features/milk_sale/domain/usecases/update_milk_buyer_usecase.dart';
...
import 'package:DairyVikas/features/milk_suppliers/data/datasources/milk_supplier_ds.dart';
import 'package:DairyVikas/features/milk_suppliers/data/repos_impl/milk_supplier_repo_impl.dart';
import 'package:DairyVikas/features/milk_suppliers/domain/repository/milk_supplier_repo.dart';
...
import 'package:DairyVikas/features/milk_suppliers/domain/usecases/update_supplier_status_usecase.dart';
...
import 'package:DairyVikas/features/notice_board/data/repo_impls/notice_board_repo_impl.dart';
...
import 'package:DairyVikas/features/plan_subscription/data/datasources/subscription_plan_ds.dart';
import 'package:DairyVikas/features/plan_subscription/data/repos_impl/subscription_plan_repo_impl.dart';
...
import 'package:DairyVikas/features/profile_and_settings/domain/usecases/update_dairy_name_usecase.dart';
import 'package:DairyVikas/features/profile_and_settings/domain/usecases/update_dairy_setting_usecase.dart';
...
import 'package:DairyVikas/features/rate_cart/data/repos_impl/rate_chart_repo_impl.dart';
import 'package:DairyVikas/features/rate_cart/domain/repository/rate_chart_repo.dart';
import 'package:DairyVikas/features/rate_cart/domain/usecases/aasign_chart_to_suppliers_usecase.dart';
import 'package:DairyVikas/features/rate_cart/domain/usecases/active_inactive_chart_usecase.dart';
import 'package:DairyVikas/features/rate_cart/domain/usecases/add_ratechart_usecase.dart';
import 'package:DairyVikas/features/rate_cart/domain/usecases/assign_chart_to_dairy_usecase.dart';
...
import 'package:DairyVikas/features/rate_cart/domain/usecases/rate_chart_details_usecase.dart';
import 'package:DairyVikas/features/rate_cart/domain/usecases/unassign_chart_to_suppliers_usecase.dart';
...
import 'package:DairyVikas/features/rate_cart/presentation/controllers/rate_chart_details_controller.dart';
